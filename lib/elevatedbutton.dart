  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      child: Stack(
        ...
        children: [
          Visibility(
            visible: !_loading, // Show label when not loading
            child: Text(
              widget.label,
              style: TextStyle(
                color: widget.fontColor, // Customizable font color
              ),
            ),
          ),
          if (_loading) // Show loading spinner when loading
            const Row(
              ...
              children: [
                SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    ...
                    strokeWidth: 2.5, // Thinner spinner stroke
                  ),
                ),
                SizedBox(width: 10),
                Text(
...
//           : Text(
//               widget.label,
//               style: TextStyle(color: widget.fontColor), // Customizable font color
//             ),
//     );
//   }
// }
